...
<!-- DAO-APK-LINK:START -->
**📱 Devin Cloud 手机版 · 直接下载 APK**（安卓本体，辅助 ②）：[⬇ DevinCloud-mobile-v0.35.8.apk](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rtflow-v0.35.8/DevinCloud-mobile-v0.35.8.apk) · 下载后允许「安装未知应用」即可装。
<!-- DAO-APK-LINK:END -->
...
|---|---|---|---|---|
| **dao-one** | `2.16.0` | `dao.dao-one` | 最终主交付：dao-vsix 二合一本源基座 + Proxy Pro 三面板子模块（折入 Devin Cloud 全功能面板），其余与 dao-vsix 完全一致。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-one-v2.16.0) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-one-v2.16.0/dao-one-2.16.0.vsix) |
| **dao-vsix** | `3.48.1` | `dao.dao-vsix` | 本源基座：rt-flow 切号视图 + Devin Cloud 全功能面板 + 本地 HTTP API（含多账号反向注入）。可单独安装。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-vsix-v3.48.1) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-vsix-v3.48.1/dao-vsix-3.48.1.vsix) |
| **rt-flow** | `4.24.0` | `devaid.rt-flow` | Devin Cloud 接入本体：对话备份 / 全量快照 / 一键回归本源 wipe / 对话额度上限。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/rt-flow-v4.24.0) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rt-flow-v4.24.0/rt-flow-4.24.0.vsix) |
...
| **rt-flow-app** | `0.35.8` | `ai.devin.rtflow` _(APK)_ | Devin Cloud 手机版 APK（安卓本体）：切号 + 内网穿透 + 网页多实例 + 浏览器自动化 + 手机本体操控 + 系统级接管 + 渐进式文档。主页可直接下载安装。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/rtflow-v0.35.8) · [⬇ APK](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rtflow-v0.35.8/DevinCloud-mobile-v0.35.8.apk) |
